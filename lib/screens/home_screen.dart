...
/// الشاشة الرئيسية للتطبيق — شريط تنقل سفلي بين الأقسام الأربعة الأساسية.
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          NavigationDestination(
              icon: Icon(Icons.emoji_events_outlined), selectedIcon: Icon(Icons.emoji_events), label: 'البطولات'),
          NavigationDestination(
              icon: Icon(Icons.groups_outlined), selectedIcon: Icon(Icons.groups), label: 'اللاعبون'),
          NavigationDestination(
